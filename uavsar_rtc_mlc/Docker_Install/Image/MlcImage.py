...
##
# This class allows the creation of a MlcImage object. The parameters that need to be set are
#\verbatim
...
#\endverbatim
#Since the MlcImage class inherits the Image.Image, the methods of initialization described in the Component package can be used.
...
class MlcImage(Image):
    ...
    def updateParameters(self):
        self.extendParameterList(Image,MlcImage)
        super(MlcImage,self).updateParameters()
    ...
    def __init__(self,family='',name=''):
        ...
        super(MlcImage, self).__init__(family if family else  self.__class__.family, name=name)

        self.initOptionalAndMandatoryLists()
        self.addDescription('Single look complex image, but is float and BIL.')  
