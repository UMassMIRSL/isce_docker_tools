...
def createMlcImage(name=''):
    from .MlcImage import MlcImage
    inst = MlcImage(name=name)
    return inst
...
contextMlcImage = image_context(createMlcImage)
