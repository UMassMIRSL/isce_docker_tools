...
class UAVSAR_mlcStack(Component):
    ...
    def extractDoppler(self):
        ...
        self.logger.info("UAVSAR_mlcStack.extractDoppler: self.dopplerVals = {}".format(self.dopplerVals))
        self.logger.info("UAVSAR_mlcStack.extractDoppler: prf = {}".format(prf))
...
#peg radius of curvature includes the terrain height
    ...
    def peg(self):
        if not self._peg:
            ...
            self.logger.info("UAVSAR_mlcStack: peg radius of curvature = {}".format(self.elp.pegRadCur))
